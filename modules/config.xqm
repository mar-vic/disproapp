...
(:
 ...
 :)
declare variable $config:default-template :="dispro-grid.html";
...
declare variable $config:data-exclude :=
    ...
    doc($config:data-root || "/o-projekte.xml")//tei:text,
...
(:~
 ...
 :)
declare variable $config:default-odd :="dispro.odd";
...
(:~
 ...
 :)
declare variable $config:odd-available :=("dispro.odd");
